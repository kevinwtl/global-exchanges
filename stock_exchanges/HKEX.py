...
class HKEX:
    ...
    class DI:
        ...
        def all_filings(self, search_day_range: int = 365):
            ...
            df['Supplementary Information'] = df['Url'].apply(lambda x: self.get_DI_supp_info(x))
        ...
        def daily_summary(dt: date = date.today()) -> pd.DataFrame:
            ...
            dfs = []
            columns_header_dict = {1:['Serial No', 'Name of listed corporation', 'Stock code', 'Class of shares', 'Name of substantial shareholder', 'Date of relevant event', 'Reason for disclosure', 'Number of shares bought / sold / involved', 'Average price per share', 'Previous No. of shares', 'Previous No. of shares (%)', 'Present No. of shares', 'Present No. of shares (%)'], 2:['Serial No', 'Name of listed corporation', 'Stock code', 'Class of shares', 'Name of substantial shareholder', 'Date of relevant event', 'Reason for disclosure', 'Number of shares bought / sold / involved', 'Average price per share', 'Previous No. of shares', 'Previous No. of shares (%)', 'Present No. of shares', 'Present No. of shares (%)'], 3:['Serial No', 'Name of listed corporation', 'Stock code', 'Class of shares', 'Name of substantial shareholder', 'Date of relevant event', 'Reason for disclosure', 'Number of shares bought / sold / involved', 'Average price per share', 'Previous No. of shares', 'Previous No. of shares (%)', 'Present No. of shares', 'Present No. of shares (%)'], 4:['Serial No', 'Name of listed corporation', 'Stock code', 'Associated Corporation', 'Name of director', 'Date of relevant event', 'Reason for disclosure', 'Currency of debentures', 'Amount of debentures bought / sold / involved', 'Average price per unit', 'Previous Balance', 'Present Balance']}
        ...
        def sid_mapping(self): return #TODO:


if __name__ == '__main__':
    df = HKEX.DI(242719).all_filings()
    print(df)